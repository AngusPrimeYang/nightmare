...
**P13–P19 射擊／敵人體力已落地**（LMB 開火、敵人 HP roll、中彈消失）。§7.2 玩法延伸 backlog **清空**。下一刀：**§7.3 流程／UI**（主選單 U1–U4、體力歸零 popup U5–U8）。
...
1. **§7.3 U1–U8**：主選單（全黑／NIGHTMARE／開始·多人灰·結束）→ 開始才進關；體力歸零 popup（繼續／回選單＋10 秒倒數，歸零自動回選單）
2. PIE 驗射擊（若尚未驗）：LMB 打 Hover/Walk 敵人，確認 HP 下降與 Despawn
3. 或鏡頭／美術換皮（§7.3 完成後）
