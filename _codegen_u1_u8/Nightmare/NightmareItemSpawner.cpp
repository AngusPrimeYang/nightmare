...
void ANightmareItemSpawner::SetSpawningEnabled(bool bEnabled)
{
	bSpawningEnabled = bEnabled;
}

void ANightmareItemSpawner::ResetSpawnerSession()
{
	PruneAliveList();
	for (const TObjectPtr<ANightmarePickupActor>& Pickup : AlivePickups)
	{
